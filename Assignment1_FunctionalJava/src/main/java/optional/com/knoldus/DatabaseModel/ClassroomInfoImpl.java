...
public class ClassroomInfoImpl implements ClassroomInfo {
    public List<Student> insertClassroomInfo()
    {
        ...
        List<String> subject3 = Arrays.asList("Scala","MySql","DAA","CNN");
        List<String> subject4 = Arrays.asList("DAA","Postman","Rust","CNN");

        Student student1 = new Student("Kunal",13, Optional.of(subject1),"A1");
        Student student2 = new Student("Vikas",11,Optional.empty(),"A1");
        Student student3 = new Student("Harshit",24,Optional.of(subject2),"xyz");
        Student student4 = new Student("Siddharth",28,Optional.of(subject3),"A2");
